...
const ListContent = (props) => {
  return props.contents.map((content) => (
    <div className="box-border flex flex-row items-center p-[40px] gap-[40px] bg-[#FAFBFC] max-w-[580px] max-h-[364px] hover:shadow-lg rounded-[12px] hover:border-[#2061F0] hover:border-solid hover:border-[1px] ">
      {/* content */}
