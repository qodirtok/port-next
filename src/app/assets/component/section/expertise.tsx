...
export default function Expertise() {
  return (
    <div className="flex flex-col sm:flex-col md:flex-col lg:flex-row justify-between items-start p-0 gap-[40px]">
      {/* text */}
      <TextExpertise />
      <ItemsExpertise />
    </div>
...
const ItemsExpertise = () => {
  return (
    <div className="flex flex-wrap items-start justify-between p-0 gap-[40px]">
      <Items
        items={[
